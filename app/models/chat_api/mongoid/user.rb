module ChatApi
  module Mongoid
    class User
      ...
      has_many :outbound_conversations, class_name: "ChatApi::Mongoid::Conversation", inverse_of: :author
      has_and_belongs_to_many :inbound_conversations, class_name: "ChatApi::Mongoid::Conversation", inverse_of: :recipients, index: true
      belongs_to :account, class_name: "ChatApi::Mongoid::Account", index: true
